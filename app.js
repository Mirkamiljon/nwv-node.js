...
const swaggerOptions = {
  swaggerDefinition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'Node.js bilan yozilgan edukatsiya platformasi uchun API hujjatlari',
    },
    servers: [
      {
...
// MongoDB ulanish
const mongoURI = process.env.MONGO_URI || 'mongodb+srv://miko:miko2007@cluster0.tqdfc.mongodb.net/edukatsiya?retryWrites=true&w=majority&appName=Cluster0';
...
app.use((req, res, next) => {
  res.status(404).json({ error: `Marshrut topilmadi: ${req.method} ${req.url}` });
});
...
httpsServer.listen(PORT, '127.0.0.1', () => {
  logger.info(`HTTPS Server https://localhost:${PORT} da ishlamoqda`);
});
